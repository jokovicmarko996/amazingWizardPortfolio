...
/* prikaze se kada se reloaduje sajt ako je u local storage-u zabelezeno da je kliknuto dugme za pustanje muzike */
const Modal = ({ onClose, toggle }) => {
  return createPortal(
    <div className="fixed inset-0 bg-background/60 backdrop:sm flex items-center justify-center">
      <div className="bg-background/20 border border-accent/30 backdrop-blur-[6px] py-8 px-6 xs:px-10 sm:px-16 rounded shadow-glass-inset text-center space-y-8">
...
const Sound = () => {
  ...
  useEffect(() => {
    ...
    /* if item is already in the local storage */
    if (
      consent &&
      consentTime &&
