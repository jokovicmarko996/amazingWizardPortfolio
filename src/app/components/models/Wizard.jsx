...
export default function Wizard(props) {
  /* ako dodje do greske kontam ovo je */
  // const { nodes, materials } = useGLTF("/models/wizard-transformed.glb");
  const { nodes, materials, scene } = useGLTF("/models/wizard-transformed.glb");

  const modelRef = useRef();

  useFrame(( state, delta, xrFrame ) => {
    // This fcn runs at the native refresh rate inside of a shared render-loop
    //  pomeraj coveculjka po visini
